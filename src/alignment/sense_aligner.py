...
def build_alignment_prompt(batch_tasks):
    ...
    system_instruction = (
        ...
        "1. **Strict 1-to-N Mapping**: You MUST NOT merge multiple Cambridge senses. Each Cambridge sense MUST form its own distinct Unified Sense. A Unified Sense can only contain exactly ONE Cambridge sense (but it can map to multiple WordNet synsets if they describe the same concept).\n"
