...
==========================================
Scrapes ALL entries from Cambridge browse pages.
"""
...
def collect_words(output_file: str = "cambridge_entries.tsv"):
    start = time.time()
    ...
    elapsed = time.time() - start
    if abort_scrape:
        print("\n[ABORTED] Scrape was stopped early due to consecutive network errors.")
